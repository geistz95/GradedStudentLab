...
public class Student {
    ...
    public Student (String fName, String lName, ArrayList<Double> exams){
        this.fName=fName;
        this.lName=lName;
        this.testScores=exams;
    }
    public Student (String fName, String lName, Double[] exams){
        this.fName=fName;
        this.lName=lName;
        this.testScores.addAll(Arrays.asList(exams));
    }
    ...
    public String getTestScores(){
        ...
        for(int i = 0; i<testScores.size();i++){
            list.append("\tExam ").append(i + 1).append(" -> ").append(testScores.get(i)).append("\n");
        }
    ...
    public void setExamScore(int whichExam, double examScore){
        testScores.set(whichExam,examScore);
    }
